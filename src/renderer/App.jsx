...
// // //                     const result = await window.electron.auth.verify(userData);
// // //                     if (result.success) {
...
//                 if (user) {
//                     const userData = JSON.parse(user);
//                     // Check if auth verification exists
//                     if (window.electron && window.electron.auth && window.electron.auth.verify) {
//                         const result = await window.electron.auth.verify(userData);
//                         if (result.success) {
//                             setCurrentUser(userData);
//                             setIsAuthenticated(true);
...
//                         }
//                     } else {
//                         // If no auth verification, just accept the user
//                         setCurrentUser(userData);
//                         setIsAuthenticated(true);
//                     }
//                 }
