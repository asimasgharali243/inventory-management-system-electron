...
//         if (window.confirm('WARNING: Restoring will replace your current database. Continue?')) {
//             setIsRestoring(true);
//             try {
//                 const result = await window.electron.database.restore();
//                 if (result.success) {
//                     toast.success('Database restored successfully! The app will now reload.');
...
//                     <li>Restoring will replace current data - ensure you have a backup</li>
//                     <li>Keyboard shortcuts: Ctrl+B for Backup, Ctrl+R for Restore</li>
//                     <li>Backup files can be stored externally for safekeeping</li>
//                 </ul>
//             </div>

//             <div className="status-bar">
//                 <span>Database Location: data/inventory.db</span>
//                 <span className="shortcuts-hint">
//                     Shortcuts: Ctrl+B Backup | Ctrl+R Restore
//                 </span>
//             </div>
//         </div>
//     );
