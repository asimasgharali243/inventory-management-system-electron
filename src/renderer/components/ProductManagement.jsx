...
//             ...prev,
//             [name]: name === 'price' || name === 'minimum_level' || name === 'current_stock' ?
...
//                                 <td dir="rtl">{product.item_name_urdu}</td>
...
//                                         <FiEdit2 />
//                                     </button>
//                                     <button className="icon-btn danger" onClick={() => handleDelete(product.item_id)}>
//                                         <FiTrash2 />
//                                     </button>
//                                 </td>
//                             </tr>
