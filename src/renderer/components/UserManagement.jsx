...
//         input: { width: '100%', padding: '10px 12px', border: '1px solid #ddd', borderRadius: '8px', fontSize: '14px', outline: 'none' },
...
//         statsBar: { marginTop: '20px', padding: '12px 16px', background: '#f8f9fa', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', fontSize: '13px', color: '#666' }
//     };
...
//                         <th style={{ ...styles.th, background: '#4CAF50', color: 'white' }}>#</th>
//                         <th style={{ ...styles.th, background: '#4CAF50', color: 'white' }}>Username</th>
//                         <th style={{ ...styles.th, background: '#4CAF50', color: 'white' }}>Full Name</th>
//                         <th style={{ ...styles.th, background: '#4CAF50', color: 'white' }}>Role</th>
//                         <th style={{ ...styles.th, background: '#4CAF50', color: 'white' }}>Created At</th>
//                         <th style={{ ...styles.th, background: '#4CAF50', color: 'white' }}>Actions</th>
//                     </tr>
//                 </thead>
//                 <tbody>
//                     {users.length === 0 ? (
...
//                                         <button
//                                             style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '6px', borderRadius: '6px', color: '#2196F3' }}
...
//                                             <button
//                                                 style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '6px', borderRadius: '6px', color: '#f44336' }}
...
//                 <div style={styles.modalOverlay} onClick={() => { setShowPasswordModal(false); setSelectedUser(null); setPasswordData({ newPassword: '', confirmPassword: '' }); }}>
//                     <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
//                         <div style={styles.modalHeader}>
//                             <h3 style={styles.modalTitle}>
//                                 <FiKey size={20} />
...
//                             </h3>
//                             <button style={styles.closeBtn} onClick={() => { setShowPasswordModal(false); setSelectedUser(null); setPasswordData({ newPassword: '', confirmPassword: '' }); }}>✕</button>
//                         </div>
...
//                         <div style={styles.modalButtons}>
//                             <button style={styles.cancelBtn} onClick={() => { setShowPasswordModal(false); setSelectedUser(null); setPasswordData({ newPassword: '', confirmPassword: '' }); }}>
//                                 <FiX size={16} /> Cancel
//                             </button>
